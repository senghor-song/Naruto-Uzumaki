...
<html lang="en">
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><title><ruiec:title/></title>
...
<body class="bodyCss">
     ...
     <section>
	    ...
	    <div class="mainRight">
	        <iframe id="main-iframe" src="/admin/common/centerForShow.shtml" width="100%" scrolling="auto" height="100%" class="main-iframe" name="main-iframe"></iframe>
	    </div>
	</section>
</body>
 	<!--js-->

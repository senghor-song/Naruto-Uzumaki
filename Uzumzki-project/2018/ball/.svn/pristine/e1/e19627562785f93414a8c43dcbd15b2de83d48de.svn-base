...
public class ApiOrderController {
	...
	public ApiMessage toPayTest(HttpServletRequest request, double amount) throws JDOMException, IOException {
		...
		Map map = WXPayJsapiUtil.getPayParams("订场预定金额", Utils.getUUID(), openid, amount, request.getRemoteAddr(), "https://ball.ekeae.com/WebBackAPI/memberapi/order/weixinNotifyTest");

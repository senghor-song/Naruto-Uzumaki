...
public class InviteJoin implements Serializable {
    ...
    /**
     * 加入约球编号
     * @return Invite_join_no 加入约球编号
     */
    public Integer getInviteJoinNo() {
        return inviteJoinNo;
    }

    /**
     * 加入约球编号
     * @param inviteJoinNo 加入约球编号
     */
    public void setInviteJoinNo(Integer inviteJoinNo) {
        this.inviteJoinNo = inviteJoinNo;
    }

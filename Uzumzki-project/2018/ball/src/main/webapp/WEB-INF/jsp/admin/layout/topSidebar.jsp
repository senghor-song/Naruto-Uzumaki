...
<ul class="navbar-nav ml-auto">
    ...
    <!-- <li class="nav-item dropdown">
        ...
        onclick="window.location.href='/WebBackAPI/admin/idea/listview'" title="建议">
    ...
    <li class="nav-item dropdown">
        <a class="nav-link nav-item-img" data-toggle="dropdown" href="#"
        onclick="window.location.href='/WebBackAPI/admin/idea/listview'" title="添加小区">
    ...
    <li class="nav-item dropdown">
        <a class="nav-link nav-item-img" data-toggle="dropdown" href="#" title="材料订单">
            <img src="/WebBackAPI/admin/static/image/9h.png" alt=""/>

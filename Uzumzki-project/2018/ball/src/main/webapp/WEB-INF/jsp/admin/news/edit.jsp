            ...
            <div class="col-lg-4">
            	<div class="col-lg-12">
	                <div class="row has-feedback">
	                    <div class="col-lg-4 nametl">资讯编号</div>
	                    <div class="col-lg-8">
	                        <input readonly="readonly" class="form-control" type="text" class="w-100" placeholder="资讯编号" value="${newsNo}">
	                    </div>
	                </div>
	            </div>
            	<div class="col-lg-12">
	                <div class="row has-feedback">
	                    <div class="col-lg-4 nametl">原始ID</div>
	                    <div class="col-lg-8">
	                        <input readonly="readonly"  id="id" class="form-control" type="text" class="w-100" placeholder="原始ID" value="${id}">
	                    </div>
	                </div>
	            </div>
            	<div class="col-lg-12">
                ...
                <div class="col-lg-12">
	                <div class="row has-feedback">
	                    ...
	                    <div class="col-lg-8">
	                        <input name="title" id="title" class="form-control" type="text" class="w-100" placeholder="标题" value="${title}">
	                    </div>
	                </div>
	            </div>
	            <div class="col-lg-12">
	                <div class="row has-feedback">
	                    ...
	                    <div class="col-lg-8">
	                        <input name="contentSimple" id="contentSimple" class="form-control" type="text" class="w-100" placeholder="摘要" value="${contentSimple}">
	                    </div>
	                </div>
	            </div>
	            <div class="col-lg-12">

...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" id="leftSidebar" data-selectindex="20"></aside>
                    ...
                    tableOption: {
                        ...
                        cols: [
                            [
                                ...
                                {field: 'courseTitle', title: '课程名', sort: true},
                                {field: 'coachName', title: '教练', sort: true},
                                {field: 'classHourSum', title: '课时', sort: true},
                                {field: 'appnickname', title: '用户', sort: true},
                                {field: 'payType', title: '状态', sort: true},
                                {field: 'amount', title: '金额', sort: true},
                                {field: 'ballType', title: '业务', sort: true},
                                {field: 'city', title: '城市', sort: true},
                                {field: 'trainTeam', title: '机构', sort: true},
                            ]
                        ]
                    },
                    menuItem: {
                        ...
                        item1: {
                            name: "查看", callback: function (key, opt) {
                                ...
                                $.tableObject({
                                    ...
                                    tableOption: {
                                        url: '/admin/train/trainloglist?id='+$(this).find("td").eq(0).attr('title'),
                                        page: true,

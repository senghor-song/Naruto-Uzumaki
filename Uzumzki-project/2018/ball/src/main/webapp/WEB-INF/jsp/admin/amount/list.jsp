                        ...
                        item2: {
                            name: "日志", callback: function (key, opt) {
                                ...
                                $.tableObject({
                                    ...
                                    tableOption: {
                                        url: '/WebBackAPI/admin/amount/amountloglist?id='+dataList[$(this).attr('data-index')].id,
                                        page: false,
                        ...
                        item3: {
                            name: "打印", callback: function (key, opt) {
                            	layer.open({
                                    ...
                                    resize: true,
                                    anim: 1,
                                    content: "/WebBackAPI/admin/amount/check?amountid="+dataList[$(this).attr('data-index')].id,
                                    maxmin: false,
                                    shadeClose: true,

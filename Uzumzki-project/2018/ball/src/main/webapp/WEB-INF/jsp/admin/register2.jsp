...
<body class="hold-transition reg0" style="background: url(/WebBackAPI/admin/static/image/bg1.jpg) no-repeat center center;">
                ...
                <form id="form" method="post" class="form-horizontal" action="target.php">
                    ...
                    <div class="form-group">
                        <div class="col-lg-9 col-lg-offset-3">
                			<a class="text-center reg20" href="/WebBackAPI/admin/common/login">返回登录</a>
                        </div>
                    </div>
                </form>
            </div>
        </section>
        <form action="/WebBackAPI/admin/" method="post" class="reg4" id="form2">
	...
	<script type="text/javascript" src="/WebBackAPI/admin/static/plugins/bootstrap-validator/vendor/jquery/jquery-1.10.2.min.js"></script>
...
//              live: 'disabled',
          ...
          $('#postBtn').click(function() {
			...
			$.ajax({  
				type : "POST",  //提交方式  
				url : "/WebBackAPI/admin/common/register",//路径  
				data : {  
					"ename" : ename,
					"password" : password,
					"rname" : rname,

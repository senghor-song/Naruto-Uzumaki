...
<form action="http://song123.iask.in/api/common/zhima" method="post">
...
<script type="text/javascript">
	$.ajax({
	    url:"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxa76f9c07c99468b2&redirect_uri=https://ball.ekeae.com/api/common/weixinLogin&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect",    //请求的url地址

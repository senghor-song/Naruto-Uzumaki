...
public class InviteController {
	...
	@ResponseBody
	public AdminMessage inviteJoinList(AdminPage adminPage, String id) {
		PageHelper.startPage(adminPage.getPage(), adminPage.getLimit());
		List<InviteJoin> list = inviteJoinMapper.selectByJoinDetails(id);
		PageInfo<InviteJoin> pageInfo = new PageInfo<>(list);
		List<Map<String, Object>> listMap = new ArrayList<Map<String, Object>>();
		for (int i = 0; i < list.size(); i++) {

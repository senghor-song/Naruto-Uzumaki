            ...
            var tableObj = {
                ...
                tableList: function () {
                    ...
                    self.obj = $.tableObject({
                        tableId: 'tableList',
                        tableOption: {
                            url: '/WebRelease/admin/order/list',
                            page: true,
                            ...
                            cols: [
                                [
                                    { field: 'paytime', title: '订单时间', sort: true },
                                    { field: 'type', title: '购买会员', sort: true },
                                    { field: 'tel', title: '充值账号', sort: true },
                                    { field: 'buyduration', title: '购买时间', sort: true },
                                    { field: 'endtime', title: '预计到期时间', sort: true },
                                    { field: 'paytype', title: '支付方式', sort: true },
                                    { field: 'payset', title: '订单金额', sort: true },
                                    { field: 'payact', title: '需付金额', sort: true },
                                    { field: 'emp', title: '下单用户', sort: true },
                                    { field: 'payresult', title: '支付状态', sort: true },
                                ]
                            ]
                        },
                        /*menuItem: {

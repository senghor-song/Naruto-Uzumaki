                    	...
                    	<div class="row mt-2">
	                        <div class="col-lg-3">
	                            <div class="row form-group has-feedback">
	                                <div class="col-lg-4 nametl2">英文名</div>
	                                <div class="col-lg-8">
	                                	<input name="ename" id="ename" class="form-control" type="text" class="w-100" placeholder="登录账户名">
	                                </div>
                            	</div>
                            </div>
	                        <div class="col-lg-3">
	                            <div class="row form-group has-feedback">
	                                ...
	                                <div class="col-lg-8">
	                                	<input name="rname" id="rname" class="form-control" type="text" class="w-100" placeholder="真实姓名">
	                                </div>
	                            </div>
                            </div>
	                        <div class="col-lg-3">
...
//      live: 'disabled',
	...
	$("#addStaff").click(function () {
        ...
        if($('#form').data('bootstrapValidator').isValid()){  
        	$.ajax({  
                type : "POST",  //提交方式  
                url : "/WebRelease/admin/staff/saveStaff",//路径  

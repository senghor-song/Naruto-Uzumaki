...
<div id="updDesc" class="saleHouse" style="min-height: 871px;">
	<ul class="sale-tab-sub">
		<li class="sale-sub-menu selected">
			<a id="modifyTitle" href="javascript:">新增我的描述</a>
		</li>
	</ul>
	...
	<div class="saleHouse-main ml8 mr8">
		<div class="houseDescManage-input-content" style="font-size: 14px;">
			标题：<input id="descName" class="houseDescManage-input">
			...
			<input type="hidden" id="isShowAnjukeXinBan" value="true">
				...
				<div class="anjukexinbanDesc claer" style="">
					<div class="ajkxbDesc js-yeZhuXingTai">
						...
						<textarea id="yeZhuXingTai" name="yeZhuXingTai" class="ajkxbTextArea"></textarea>  
					</div>
					<div class="ajkxbDesc js-xiaoQuPeiTao">
						<span class="descHeader"><span class="font-bold">小区配套:</span><span class="col-999">从交通、教育、医疗、内部环境、车位情况、安保措施方面来描述</span><span class="col-f60">(字数限制20-300)</span></span>
						<textarea id="xiaoQuPeiTao" name="xiaoQuPeiTao" class="ajkxbTextArea"></textarea>  
					</div>
					<div class="ajkxbDesc js-fuWuJieShao">
						<span class="descHeader"><span class="font-bold">服务介绍:</span><span class="col-999">多角度描述您的服务优势，例如：行业年限、专业经验、服务态度、可提供的服务种类（比如代办贷款）等</span><span class="col-f60">(字数限制20-300)</span></span>
						<textarea id="fuWuJieShao" name="fuWuJieShao" class="ajkxbTextArea"></textarea>  
					</div>
					<div class="ajkxbDesc js-shuiFeiXinxi">
						<span class="descHeader"><span class="font-bold">税费信息:</span><span class="col-999">相关费用，描述越详尽您的房源质量就会越高，展示给网友的机会就会增加(仅搜房帮)</span><span class="col-f60">(字数限制20-300)</span></span>
						<textarea id="shuiFeiXinxi" name="shuiFeiXinxi" class="ajkxbTextArea"></textarea>  
					</div>
				</div>
			
		</div>
		<div class="saleManager-bottom center">
			<button id="btn_update" class="btn_g">新增</button>
...
$(function(){
	...
	$("#btn_update").click(function() {
		...
		var url = "/WebRelease/massEmpSaleTemplate/saveDescribe";

                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-lg-4 listrow">
                            ...
                            <span class="ncon">
                                <input type="radio" name="status" <c:if test="${newsHead.status eq '展示'}"> checked="checked"</c:if>> 展示
                                <input type="radio" name="status" <c:if test="${newsHead.status eq '下架'}"> checked="checked"</c:if>> 下架
                            </span>
                        </div>
                        <div class="col-lg-4 listrow">
                            <span class="nti">是否顶置：</span>
                            <span class="ncon">
                                <input type="radio" name="staff" <c:if test="${newsHead.flagtop == 1}"> checked="checked"</c:if>> 是
                                <input type="radio" name="staff" <c:if test="${newsHead.flagtop == 0}"> checked="checked"</c:if>> 否
                            </span>
                        </div>

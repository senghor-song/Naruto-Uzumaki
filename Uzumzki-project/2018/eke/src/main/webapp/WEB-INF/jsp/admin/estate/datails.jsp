...
<div class="contextMenuDialog" id="item2">
                        	...
                        	<div class="row">
	                            <div class="col-lg-6">
	                                <div class="row form-group has-feedback">
	                                    ...
	                                    <div class="col-lg-8"> 
	                                    	<input name="id" type="hidden" value="${estate.id}">
	                                        <input name="estate" id="estate" class="form-control" type="text" class="w-100" placeholder="" value="${estate.estate}">
	                                    </div>
	                                </div>
	                            </div>
	                            <!-- <div class="col-lg-6">
	                                <div class="row form-group has-feedback">
	                                    ...
	                                    <div class="col-lg-8">
	                                        <input name="" class="form-control" type="text" class="w-100" placeholder="" value="">
	                                    </div>
	                                </div>
	                            </div>
	                            <div class="col-lg-6">
	                            ...
	                            <div class="col-lg-6">
	                                <div class="row form-group has-feedback">
	                                    ...
	                                    <div class="col-lg-8">
	                                        <select name="morecompleteyear" class="form-control" id="" value="${estate.morecompleteyear}">
	                            ...
	                            <div class="col-lg-6">
	                                <div class="row form-group has-feedback">
	                                    ...
	                                    <div class="col-lg-8">
	                                        <input name="morefee" class="form-control" type="text" class="w-100" placeholder="元/平米" value="${estate.morefee}">
	                                    </div>
	                                </div>
	                            </div>
	                            <div class="col-lg-6">
	                                <div class="row form-group has-feedback">
	                                    ...
	                                    <div class="col-lg-8">
	                                        <input name="moreroom" class="form-control" type="text" class="w-100" placeholder="" value="${estate.moreroom}">
	                                    </div>
	                                </div>
	                            </div>
	                            <div class="col-lg-6">
	                                <div class="row form-group has-feedback">
	                                    ...
	                                    <div class="col-lg-8">
	                                        <select name="moretype" class="form-control" id="${estate.moretype}">
	                            ...
	                            <div class="col-lg-6">
	                                <div class="row form-group has-feedback">
	                                    ...
	                                    <div class="col-lg-8">
	                                        <input name="moreparking" class="form-control" type="text" class="w-100" placeholder="" value="${estate.moreparking }">
	                                    </div>
	                                </div>
	                            </div>
	                            <div class="col-lg-6">
	                                <div class="row form-group has-feedback">
	                                    ...
	                                    <div class="col-lg-8">
	                                        <input name="mgttel" class="form-control" type="text" class="w-100" placeholder="" value="${estate.mgttel}">
	                                    </div>
	                                </div>
	                            </div>
	                            <div class="col-lg-6">
	                                <div class="row form-group has-feedback">
	                                    ...
	                                    <div class="col-lg-8">
	                                        <input name="moredeveloper" class="form-control" type="text" class="w-100" placeholder="" value="${estate.moredeveloper }">
	                                    </div>
	                                </div>
	                            </div>
	                            <input type="hidden" value="${estate.cityid}" id="cityid">
	                            <input type="hidden" value="${estate.districtid}" id="districtid">
	                            <input type="hidden" value="${estate.areaid}" id="areaid">
	                            <div class="col-lg-6">
	                                <div class="row form-group has-feedback">
	                                    ...
	                                    <div class="col-lg-8">
	                                        <select name="cityid" class="form-control" id="city" onchange="citySelect()" disabled="disabled">
	                                        	<c:forEach items="${citys}" var="city">
		                                            <option value="${city.id }" <c:if test="${city.id == estate.cityid}"> selected="selected" </c:if>>${city.city }</option>
	                                        	</c:forEach>
	                                        </select>
	                                    </div>
	                                </div>
	                            ...
	                            <div class="col-lg-12">
	                                <div class="row form-group has-feedback">
	                                    ...
	                                    <div class="col-lg-10">
	                                        <input name="moremgt" class="form-control" type="text" class="w-100" placeholder="" value="${estate.moremgt }">
	                                    </div>
	                                </div>
	                            </div>
	                            <div class="col-lg-12">
	                                <div class="row form-group has-feedback">
	                                    ...
	                                    <div class="col-lg-10">
	                                        <textarea name="moredescribe" class="form-control" id="" cols="30" rows="5">${estate.moredescribe}</textarea>
	                                    </div>
	                                </div>
	                            </div>
	                            <div class="col-lg-12">
	                                <div class="row mt-2">
	                                    ...
	                                    <div class="col-lg-10">
	                                        <button class="form-control btn btn-primary w-25" id="updateEstate" >保存</button>
	                                    </div>
	                                </div>
	                            </div>
	                            <input type="hidden" value="${estate.longitude}" id="lng" name="longitude">
	                            <input type="hidden" value="${estate.latitude}" id="lat" name="latitude">
	                            <input type="hidden" value="${estate.address}" id="address" name="address">
                        	</div>
                        </form>
                    </div>
                </div>
	...
	<script type="text/javascript" src="/WebRelease/admin/static/plugins/bootstrap-validator/dist/js/bootstrapValidator.js"></script>
					<script type="text/javascript">
						var flag = ${estate.longitude == 0 && estate.latitude == 0 };
	...
	//	                      live: 'disabled',
		            	...
		            	$("#updateEstate").click(function () {
		                    ...
		                    if($('#form').data('bootstrapValidator').isValid()){  
			                	$.ajax({  
			                        type : "POST",  //提交方式  
			                        url : "/WebRelease/admin/estate/update",//路径  
		                        	...
		                        	if(list.length > 0){
			    						$.each(list,function(n,value) {
			    							if(districtid == value.id){
				    							$("#district").append("<option value='"+value.id+"' selected='selected'>"+value.district+"</option>");
			    							}else{
		            		...
		            		$.ajax({  
		                        ...
		                        success : function(result) {//返回数据根据结果进行相应的处理  
		                        	...
		                        	if(list.length > 0){
			    						$.each(list,function(n,value) {  
			    							if(areaid == value.id){
				    							$("#area").append("<option value='"+value.id+"' selected='selected'>"+value.area+"</option>");
			    							}else{

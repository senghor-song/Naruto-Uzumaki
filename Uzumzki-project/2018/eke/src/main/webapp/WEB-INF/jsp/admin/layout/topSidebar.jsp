...
<ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block nav-item-img">
        <a href="index.html" class="nav-link" title="巡检，分辨率必须=1920*1080，全屏模式">
            <img src="/WebRelease/admin/static/image/5.png" alt=""/>
        </a>
    </li>
    <li class="nav-item d-none d-sm-inline-block nav-item-img">
        <a href="/WebRelease/admin/baiduMap/index" class="nav-link mymap" title="沙盘">
            <img src="/WebRelease/admin/static/image/6.png" alt=""/>
        </a>
    </li>
    <li class="nav-item d-none d-sm-inline-block nav-item-img">
        <a href="index.html" class="nav-link mymessage" title="OM">
            <img src="/WebRelease/admin/static/image/7.png" alt=""/>
        </a>
    </li>
    <li class="nav-item d-none d-sm-inline-block nav-item-img">
        <a href="index.html" class="nav-link mymessage" title="短信">
            <img src="/WebRelease/admin/static/image/8h.png" alt=""/>
        </a>
    </li>
</ul>
...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
        ...
        onclick="window.location.href='/WebRelease/admin/idea/listview'" title="建议">
            <img src="/WebRelease/admin/static/image/11h.png" alt=""/>
            <span class="badge badge-danger navbar-badge" id="proposalSum">0</span>
        </a>
    </li>
    <!-- Notifications Dropdown Menu -->
    <li class="nav-item dropdown">
        <a class="nav-link nav-item-img" data-toggle="dropdown" href="#"
        onclick="window.location.href='/WebRelease/admin/idea/listview'" title="添加小区">
            <img src="/WebRelease/admin/static/image/13h.png" alt=""/>
            <span class="badge badge-warning navbar-badge" id="estateFindSum">0</span>
        </a>
    </li>
    <li class="nav-item dropdown">
        <!-- SEARCH FORM -->
    ...
    <!-- <li class="nav-item dropdown">
        <a class="nav-link nav-item-img" data-toggle="dropdown" href="#" title="材料订单">
            <img src="/WebRelease/admin/static/image/9h.png" alt=""/>
            <span class="badge badge-danger navbar-badge">0</span>
        </a>
    </li> -->
    <!-- <li class="nav-item dropdown">
        <a class="nav-link nav-item-img" data-toggle="dropdown" href="#" title="公盘">
            <img src="/WebRelease/admin/static/image/10h.png" alt=""/>
            <span class="badge badge-danger navbar-badge">0</span>
        </a>
    </li> -->
    <li class="nav-item dropdown">
        <a class="nav-link nav-item-img" data-toggle="dropdown" href="#" title="合作续期" 
        onclick="window.location.href='/WebRelease/admin/store/listview'">
            <img src="/WebRelease/admin/static/image/12h.png" alt=""/>
    ...
    <li class="nav-item dropdown">
        <a class="nav-link nav-item-img out-margin-left" href="javascript:;" data-href="login.html" id="logout" >
            <img src="/WebRelease/admin/static/image/u5427.png" alt="" title="注销"/>
        </a>
    </li>
</ul>
...
<div id="mapDiv" class="otherDialog hide">
    <div style=" position: relative; top: 0px;">
        <img src="/WebRelease/admin/static/image/123.jpg" class="w-100" alt=""/>
    </div>

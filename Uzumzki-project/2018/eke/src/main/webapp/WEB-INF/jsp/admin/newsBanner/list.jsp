...
<body class="hold-transition sidebar-mini">
            ...
            var tableObj = {
                ...
                tableList: function () {
                    ...
                    self.obj = $.tableObject({
                        tableId: 'tableList',
                        tableOption: {
                            url: '/WebRelease/admin/newsBanner/list',
                            page: true,
                            ...
                            item4: {
                                name: "修改日志", callback: function (key, opt) {
                                    ...
                                    $.tableObject({
                                        tableId: 'tablelog',
                                        tableOption: {
                                            url: '/WebRelease/admin/newsBanner/newsBannerLog/list?id=' + dataList[$(this).attr('data-index')].id,
                                            page: true,
    ...
    <img src="/WebRelease/admin/static/image/u78455.jpg" alt="" style="width200px; height:100px;">
  	</script>
                ...
                <div class="col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div>
                                <img src="/WebRelease/admin/static/image/u34875.jpg" alt style="height: 200px; border:1px solid #eee;">
                            </div>
                        </div>
                    </div>

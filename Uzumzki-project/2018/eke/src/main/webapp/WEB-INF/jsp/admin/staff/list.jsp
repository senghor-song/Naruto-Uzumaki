    ...
    <script>
        $(function () {
            var tableObj = {
                ...
                tableList: function () {
                    ...
                    self.obj = $.tableObject({
                        tableId: 'tableList',
                        tableOption: {
                            url: '/WebRelease/admin/staff/list',
                            page: true,
                            ...
                            item2: {
                                name: "变更", callback: function (key, opt) {
                               		layer.open({
                                        ...
                                        resize: true,
                                        anim: 1,
                                        content: "/WebRelease/admin/staff/editStaff?id="+dataList[$(this).attr('data-index')].id,
                                        maxmin: false,
                                        shadeClose: true,
                                ...
                                name: "删除", callback: function (key, opt) {
                                	...
                                	layer.open({
                                        ...
                                        yes: function (index) {
                                        	$.ajax({  
                                                type : "POST",  //提交方式  
                                                url : "/WebRelease/admin/staff/delStaff",//路径  
            ...
            $("#create").on("click", function () {
            	$.ajax({  
                    type : "POST",  //提交方式  
                    url : "/WebRelease/admin/staff/addStaff",//路径  

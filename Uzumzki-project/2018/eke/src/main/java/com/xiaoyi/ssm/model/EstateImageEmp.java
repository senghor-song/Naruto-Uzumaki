...
public class EstateImageEmp implements Serializable{
	
    /** 序列化 */
	private static final long serialVersionUID = -5969845388015917453L;
	
    /**
     * 租售->小区图（经纪人）https://img.ekeae.com
     */
    private String id;
    ...
    /**
     * 租售->小区图（经纪人）https://img.ekeae.com
     * @return ID 租售->小区图（经纪人）https://img.ekeae.com
     */
    public String getId() {
        return id;
    }
    ...
    /**
     * 租售->小区图（经纪人）https://img.ekeae.com
     * @param id 租售->小区图（经纪人）https://img.ekeae.com
     */

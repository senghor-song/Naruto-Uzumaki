...
public class MassPersonRentEmpCondi implements Serializable{
	
    /** 序列化 */
	private static final long serialVersionUID = -5969845388015917453L;
	
    /**
     * 推房->经纪人检索条件(个人出租)一个人最多40条记录
     */
    private String id;
    ...
    /**
     * 推房->经纪人检索条件(个人出租)一个人最多40条记录
     * @return ID 推房->经纪人检索条件(个人出租)一个人最多40条记录
     */
    public String getId() {
        return id;
    }
    ...
    /**
     * 推房->经纪人检索条件(个人出租)一个人最多40条记录
     * @param id 推房->经纪人检索条件(个人出租)一个人最多40条记录
     */

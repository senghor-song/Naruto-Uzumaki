...
<body class="bodyCss">
        ...
        <section>
            ...
            <div class="mainRight">
                <div class="pancl_pd">
                    <form  action="/admin/db/update.shtml" method="get" id="form1">
                        <div class="tit_menu_list">
                            ...
                            <c:if test="${dbShow.parentId!=null }">
                            <i class="fl split_gt">&gt;</i>
                            <a href="/admin/dbShow/list.shtml?pid=${dbShow.parentId }" class="m_menu_item refresh_html">
                                <em>可导入字段展示列表</em>
                            </a>
                            </c:if>
                            <i class="fl split_gt">&gt;</i>
                        ...
                        <input type="hidden" name="parentId" value="${dbShow.parentId }" />
                        <input type="hidden" name="id" value="${dbShow.id }" />
                        <div class="mgt20 new-people-box form_box">
                        	<dl class="new_peo_list">
                                <c:if test="${dbShow.parentId==null }"><dt>表名：</dt></c:if>
                                <c:if test="${dbShow.parentId!=null }"><dt>字段名：</dt></c:if>
                                <dd>
                                     <div class="fl left_item">
                                       <input type="text" class="txt_in" value="${dbShow.dbName }" name="dbName" maxlength="50" />
                                    </div>
                                </dd>
                            </dl>
                            <c:if test="${dbShow.parentId!=null }">
                                ...
                                <dd>
                                    <div class="fl rule-single-select single-select">
                                        <select class="sel" name="fieldType">
                                            ...
                                            <option <c:if test="${dbShow.fieldType==1 }">selected="selected"</c:if> value="1">字符串</option>
                                            <option <c:if test="${dbShow.fieldType==2 }">selected="selected"</c:if> value="2">日期</option>
                                        </select>
                                    </div>
                                </dd>
                            </dl>
                                ...
                                <dd>
                                    <div class="fl rule-single-select single-select">
                                        <select class="sel" name="isNeed">
                                            ...
                                            <option <c:if test="${dbShow.isNeed==1 }">selected="selected"</c:if> value="1">是</option>
                                        </select>
                                    </div>
                                </dd>
                            </dl>
                            ...
                            <dl class="new_peo_list">
                                ...
                                <dd>
                                    <div class="fl left_item">
                                       <input type="text" class="txt_in" value="${dbShow.name }" name="name" maxlength="10" />

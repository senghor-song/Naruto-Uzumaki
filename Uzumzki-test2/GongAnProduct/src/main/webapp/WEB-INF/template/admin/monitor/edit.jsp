...
<body class="bodyCss"> 
            ...
            <div class="mainRight">
                <div class="pancl_pd">
                    <div class="new-people-box xzzdr">
                        <form id="form1" action="/admin/monitor/update.shtml" method="post">
                            ...
                            <div class="pdt65 new-nan-top">
                                <div class="img_shows">
                                    ...
                                    <sapn class="upload_btn">
                  				 	...
                  				 	<input id="fileUrl"  datatype="*" isNot="true" type="hidden" name="photo" value="${monitor.photo}" nullmsg="请上传头像">
                                </div>
                                <dl class="new_peo_list">
	                                <dt><span style="color:red">*</span>姓名：</dt>
                                    <dd>
                                        <div class="fl left_item">
                                            <input type="text" name="name" value="${monitor.name}" class="txt_in " datatype="/[\u4e00-\u9fa5·]$/" nullmsg="请输入姓名" 
                                ...
                                <dl class="new_peo_list">
                                    ...
                                    <dd>
                                        <div class="fl left_item">
                                        	...
                                        	<!--  datatype="isIDCard" -->
                                            <input type="text" value="${monitor.idCard}" isnot="true" maxlength="18" id="shenfengzheng_card" acttype="edit" name="idCard" datatype="isIDCard" nullmsg="请输入身份证号" placeholder="请输入身份证号" class="txt_in"  onkeyup="idCardKeyUp($(this))" />
                                        </div>
                                    </dd>
                                </dl>
                                <dl class="new_peo_list">
                                        ...
                                        <div class="fl left_item">
                                            <select class="sel" id="nation" name="nationNumber" datatype="*" nullmsg="请在字典添加民族数据！">
                                                ...
                                                <c:forEach var="list" items="${nations}">
                                                	<option value="${list.id }" <c:if test="${list.id == monitor.nationNumber}">selected="selected"</c:if>>${list.itemName }</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                        <div class="fl mgl100 right_item">
                                           <label class="fl">
                                                ...
                                                <label class="radio_i label_item m_b">
	                                                <input type="radio" value="男" name="sex" <c:if test="${monitor.sex == '男'}">checked="checked"</c:if>>
		                                            <i class="iconfont"></i>
		                                            <font class="middle">男</font>
												</label>
                                                <label class="radio_i label_item">
	                                                <input type="radio" value="女" name="sex" <c:if test="${monitor.sex == '女'}">checked="checked"</c:if>>
		                                            <i class="iconfont"></i>
                                            ...
                                            <div class="">
                                                <select class="fl sel" id="personnelType" disabled="disabled">
	                                                	<c:forEach var="list" items="${monitorType}">
			                                                <option value="${list.id }"<c:if test="${list.id == monitor.personTypeId}">selected="selected"</c:if>>${list.itemName }</option>
		                                               	</c:forEach>
                                ...
                                <dl class="new_peo_list">
                                    ...
                                    <dd>
                                        <div class="fl left_item">
                                            <input id="licensePlateNumber" type="text" isnot="true" name="licensePlateNumber" value="${monitor.licensePlateNumber}" placeholder="请输入车牌号" class="txt_in fl txt" maxlength="10">
                                        </div>
                                        <div class="fl mgl100 right_item">
                                            <label>
                                                <span>联系方式：</span>
                                                <input id="contactInfo" type="text" isnot="true" placeholder="请输入联系方式" name="contactInfo" value="${monitor.contactInfo}" class="txt_in" maxlength="11"
                                ...
                                <dl class="new_peo_list">
                                    ...
                                    <dd>
                                        <div class="fl left_item">
                                            <input id="currentAddress" type="text" isnot="true" name="currentAddress" value="${monitor.currentAddress}" placeholder="请输入现住地址" class="txt_in txt" maxlength="50">
                                        </div>
                                        <div class="fl mgl100 right_item">
                                            <label>
                                                <span>户籍地址：</span>
                                                <input id="nativeAddress" type="text" name="nativeAddress" placeholder="请输入户籍地址" value="${monitor.nativeAddress}" class="txt_in txt" maxlength="50">
                                            </label>
                                        </div>
                                    </dd>
                                </dl>
                            ...
                            <div class="new-nan-top lieguan-box">
								...
								<dl class="new_peo_list" id="Categories_peo">
                                    ...
                                    <dd>
                                    	...
                                    	<c:forEach var="dictionary" items="${monitor.monitorTypes}">
                                ...
                                <dl class="new_peo_list">
                                    ...
                                    <dd>
                                     	<input type="hidden" value="${monitor.userId}" name="parentUserId" id="parentUserId"/>
                                     	<input type="hidden" value="${unit2}" id="parentUnitId">
                                    	...
                                    	<c:if test="${!empty isUser}">
	                                        ...
	                                        <div class="fl left_item">
	                                            <select class="sel " name="userId" id="userId">
                                    ...
                                    <dd>
                                        <div class="fl left_item">
                                            <select class="sel " name="duration" id="duration">
                                                ...
                                                <option value="20" <c:if test="${list.id == monitor.duration}">selected="selected"</c:if>>20天</option>
                                                <option value="30" <c:if test="${list.id == monitor.duration}">selected="selected"</c:if>>30天</option>
                                            </select>
                                        </div>
                                    </dd>
                                </dl>
                                    ...
                                    <dd>
                                    	<select class="sel " name="handleMode" id="handleMode" datatype="*" nullmsg="请选择一个布控措施！">
                                    		...
                                    		<c:forEach items="${disposalMeasure}" var="list">
                                    			<option value="${list.id }" <c:if test="${list.id == monitor.handleMode}">selected="selected"</c:if>>${list.itemName }</option>
                                    		</c:forEach>
                                        </select>
                                    </dd>
                                </dl>
                                <dl class="new_peo_list">
                                    ...
                                    <dd>
                                        <div class="fl mgl200 right_item">
                                            <input id="contactsPolice" type="text" isnot="true" value="${monitor.contactsPolice}" placeholder="请输入民警电话" name="contactsPolice" class="txt_in"
                                ...
                                <dl class="new_peo_list">
                                    ...
                                    <dd>
                                        ...
                                        nullmsg="请输入布控理由" errormsg="请输入布控理由" maxlength="200" datatype="*">${monitor.reason}</textarea>
    ...
    $(function(){
    	var uid = '${monitor.userId}';
    	var ssuid = '${sessionScope.user.id}';
	...
	function unitIdList(selID,selTwoId,userIdList,_choseType,firstVal){
		...
		$('#Categoriess').on('click',function(){
			...
			for(var i=1;i<_val.length;i++){
				str +=	"<div class='mgr10 select_checked'><em class='m_b'>"+
				_val[i-1]

...
<body class="bodyCss">
    ...
    <!---->
    <section>
      	<jsp:include page="../common/leftNav4.jsp"></jsp:include> 
	    <div class="mainRight">
	        <iframe id="main-iframe2" src="/admin/informationAnalysis/dateCollect.shtml" width="100%" scrolling="auto" height="100%" class="main-iframe2" name="main-iframe2"></iframe>
	    </div>
	</section>
</body>
 	<!--js-->

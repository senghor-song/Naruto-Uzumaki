     ...
     <div class="allSelect">
        ...
        <c:if test="${page.pageNumber ne 1 }">    
            <li>
	        	...
	        	<a class="label_btn" href="javascript:;" onclick="loadPage(${typeId},1)">首页</a>
	        	</div>
	        </li>
        </c:if>
        <c:if test="${page.pageNumber gt 1}">
            <li>
	        	<div id="columnTubeMode" class="fl left_item chose_stare">
	        	<a class="label_btn" href="javascript:;" onclick="loadPage(${typeId},${page.pageNumber-1 })">上一页</a>
	        	</div>
	        </li>
        </c:if>
        ...
        <c:forEach var="num" begin="${page.pageNumber-2 < 1 ? 1 : page.pageNumber-2 }" step="1" end="${page.pageNumber+2 > page.pageCount ? page.pageCount : page.pageNumber+2 }">
            ...
            <c:if test="${num ne page.pageNumber }">
                <li><a href="javascript:;" onclick="loadPage(${typeId},${num})">${num }</a></li>
            </c:if>
        </c:forEach>
        ...
        <c:if test="${page.pageCount gt page.pageNumber }">
            <li>
	        	<div id="columnTubeMode" class="fl left_item chose_stare">
	        	<a class="label_btn" href="javascript:;" onclick="loadPage(${typeId},${page.pageNumber+1 })">下一页</a>
	        	</div>
        	</li>
        </c:if>
        ...
        <c:if test="${page.pageNumber ne page.pageCount }">
            <li class="lh30">
	        	<div id="columnTubeMode" class="fl left_item chose_stare">
	        	<a  class="label_btn" href="javascript:;" onclick="loadPage(${typeId},${page.pageCount })">尾页</a>
	        	</div>
	        </li>
        </c:if> 
        ...
        <li><a href="javascript:;" class="go" onclick="loadPage(${typeId},$('#goto').val())">GO</a></li>
        <%-- <li>

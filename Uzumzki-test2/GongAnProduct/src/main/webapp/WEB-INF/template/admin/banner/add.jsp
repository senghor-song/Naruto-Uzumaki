            ...
            <div class="mainRight">
                <div class="pancl_pd">
                    <div class="new-people-box early_warning_box">
                        <form  id="form1" method="post"  action="/admin/banner/save.shtml">
									...
									<dl class="new_peo_list">
										...
										<dd>
											<span class="fl img_box" style="width: 200px;height: 150px;"> 
											    <img id="face_pic" src="${base}/resources/admin/images/Avatar.png" style="width:200px;"/>
											</span> 
											<span class="upload_btn" style="margin: 108px 0px 0px 12px;"> 
											    <a class="upd_btn" id="uploaderFace">上传图片</a>
											</span> 
											<input type="file" id="upload_file" style="display: none;" />
											<input id="fileUrl" datatype="*" isNot="true" nullmsg="请上传图片" value="" type="hidden" name="image">
										</dd>
									</dl>
								</div>
							</div>

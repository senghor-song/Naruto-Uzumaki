...
public interface MonitorService extends BaseService<Monitor, Integer>{
	 ...
	 */
	Map<String, Object> selOneByIdCard(Integer id,Integer ptype);
	 ...
	 * @date 2018年1月9日 下午4:04:27
	 */
	String isAudit(User user,LoginUserUnit loginUserUnit,Monitor monitor);
	 ...
	 * 查询我管理的布控人员
	 * @author Senghor<br>
	 * @date 2018年4月10日 下午4:44:09
	 */
	Map<String, Object> findByPage(Page page, User loginUser, LoginUserUnit loginUserUnit,String type);

    /**
     * 查询布控人员信息
     * @author Senghor<br>
     * @date 2018年4月18日 下午3:29:03
     */

...
<body class="rest_select2">
	<div class="pd15_25 lay_wind" id="lay_wind1">
		<div class="lay_form">
			<form action="/admin/unit/toLeadExcel.shtml" method="post"
				enctype="multipart/form-data" id="toLeadExcel">
				<div class="lay_form_wrap">
					<dl class="lay_form_list">
						<dt>下载模板：</dt>
						<dd>
							<a href="${base }/resources/admin/execl/单位模板.xlsx"
								download="单位模板.xlsx">单位模板</a>
						</dd>
					</dl>
				</div>
				<div class="lay_form_wrap">
	...
	<script type="text/javascript">
	  ...
	  if($(".uploader_wrap").length>0){
		  ...
		  var Myuploader = WebUploader.create({
              ...
              server:"/admin/unit/toLeadExcel.shtml", 
              pick: {
                  id: '#' + _btnId,
                  multiple:false
              }, 

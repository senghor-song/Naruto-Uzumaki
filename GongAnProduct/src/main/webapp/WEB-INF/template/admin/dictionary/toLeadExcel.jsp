...
<link rel="stylesheet"
	href="${base }/resources/admin/js/select/select2.css">
...
<body class="rest_select2">
	<div class="pd15_25 lay_wind" id="lay_wind1">
		<div class="lay_form">
			<form action="/admin/controlPerson/toLeadExcel.shtml" method="post"
				enctype="multipart/form-data" id="toLeadExcel">
				<div class="lay_form_wrap">
					<dl class="lay_form_list">
						<dt>下载模板：</dt>
						<dd>
							<a href="${base }/resources/admin/execl/人员类别模板.xlsx">下载模板</a>
						</dd>
					</dl>
				</div>
				<div class="lay_form_wrap">
	...
	<script
		src="${base }/resources/admin/js/webuploader/webuploader.min.js"></script>
	<script src="${base }/resources/admin/js/webuploader/myuploader.js"></script>
	<!--下拉框-->
	<script type="text/javascript"
		src="${base }/resources/admin/js/select/select2.js"></script>
	<script type="text/javascript">
    	<!--导入-->
	  //绑定页面的上传图片的JS
	  if($(".uploader_wrap").length>0){
		  ...
		  var Myuploader = WebUploader.create({
              ...
              server:"/admin/dictionary/toLeadExcel.shtml", 
              pick: {
                  id: '#' + _btnId,
                  multiple:false
              }, 

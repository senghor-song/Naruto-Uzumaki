                    ...
                    <form  action="/admin/db/update.shtml" method="get" id="form1">
                        ...
                        <div class="mgt20 new-people-box form_box">
                                ...
                                <dd>
                                    <div class="fl rule-single-select single-select">
                                        <select class="sel" name="type">
                                            ...
                                            <option <c:if test="${db.type==2 }">selected="selected"</c:if> value="2">oracle</option>
                                        </select>
                                    </div>
                                </dd>
                            </dl>
                            <dl class="new_peo_list">
                                ...
                                <dd>
                                     <div class="fl left_item">
                                       <input type="text" value="${db.url }" class="txt_in" style="width:800px" name="url" maxlength="200" dataType="*"/>
                                    </div>
                                </dd>
                            </dl>
                            <dl class="new_peo_list">
                                ...
                                <dd>
                                    <div class="fl left_item">
                                       <input type="text" value="${db.userName }" class="txt_in" name="userName" dataType="*"/>
                            ...
                            <dl class="new_peo_list">
                                ...
                                <dd>
                                    <div class="fl left_item">
                                        <input type="text" value="${db.password }" class="txt_in"  name="password" dataType="*"/>
                                    </div>
                                </dd>
                            </dl>
                        </div>

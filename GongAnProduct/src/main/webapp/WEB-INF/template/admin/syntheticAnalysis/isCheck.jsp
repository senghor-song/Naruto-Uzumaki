...
<body class="rest_select2">
    <div class="pd15_25 lay_wind" id="lay_wind1">
        ...
        <div class="lay_form">
            <form action="/admin/syntheticAnalysis/saveIsCheck.shtml?taskId=${taskDTO.taskId}&isCheck=${taskDTO.isCheck}" method="post" id="form_layer">
                <div class="lay_form_wrap">
                    <dl class="lay_form_list">
                        <dt>拒绝理由：</dt>
                        <dd>
                            <div class="fl left_item">
                                <textarea name="content" isnot="true" class="fl textarea text_keyup" placeholder="请输入拒绝理由" onkeyup="checkLen(this)"
                               	 	nullmsg="请输入拒绝理由" errormsg="请输入拒绝理由" maxlength="50" datatype="*"></textarea>
                                <div class="fl add_btn_wrap">
								<span class="tips"><i class="m_242"><em class="text_keyup_num">0</em>/50</i>（最多可输入50字）</span>
                                </div>	
                            </div>
                        </dd>
                    </dl>

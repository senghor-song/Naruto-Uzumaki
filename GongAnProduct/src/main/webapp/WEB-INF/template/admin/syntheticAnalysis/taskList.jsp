...
<body class="bodyCss">
        ...
        <section>
            ...
            <div class="mainRight">
                <div class="pancl_pd">
                    <form action="/admin/syntheticAnalysis/taskList.shtml" method="get" id="searchform">
                        ...
                        <div class="mgt15 importantC">
                            <div id="mgt15 rylbCount">
                            	<c:if test="${sessionScope.user.id != 1}">
	                            	<a class="mgl10 m_b" href="/admin/syntheticAnalysis/taskList.shtml">我发起的任务</a> 
	                            	<a class="mgl10" href="/admin/syntheticAnalysis/myTaskList.shtml">我接收的任务</a> 
                            	</c:if>
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<c:if test="${list.status ne '3'}">
	                                            		<a href="javascript:;" class="m_blue" onclick="openOver(${list.id})">结束</a>
		                                            	<c:if test="${list.isCheck eq 0}">
			                                                <i class="m_e8">|</i>
			                                                <a href="/admin/syntheticAnalysis/edit.shtml?taskId=${list.id}" class="m_blue">编辑</a>
		                                            	</c:if>
	                                            	</c:if>

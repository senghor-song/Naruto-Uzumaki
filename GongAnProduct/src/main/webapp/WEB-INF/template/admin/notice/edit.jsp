...
<body class="bodyCss">
       ...
       <!--头部-->
        ...
        <section>
            ...
            <div class="mainRight">
                <div class="pancl_pd">
                    <form action="/admin/notice/update.shtml" method="post" id="form1">
                            ...
                            <dl class="new_peo_list">
                                ...
                                <dd>
                                     <div class="fl left_item">
                                       <input type="text" class="txt_in" name="title"  maxlength="30" value="${notice.title }"/>
                                    </div>
                                </dd>
                            </dl>
						<dl class="new_peo_list">
							<dt>内容：</dt>
							<dd>
								<textarea datatype="*" maxlength="1000" nullmsg="请输入内容" name="content" class="fl textarea" onkeyup="checkLen(this)">${notice.content }</textarea>
					...
					<div class="state-save sub_btn_box">
						<input onclick="javascript:history.back(-1);" type="button"
							value="返回上一页" value="返回上一页" class="back_next" /> <input
							type="submit" value="保存" class="sub_btn" />
					</div>
				</form>
              </div>
            </div>

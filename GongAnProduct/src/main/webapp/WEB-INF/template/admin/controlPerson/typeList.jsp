...
<c:forEach var="list" items="${dynamicInfos}">
	<a href="javascript:;" onclick="loadPage(${list.id },1)" class="personal_catalogue_list"> 
		<ruiec:apiConfig var="apiConfig" apiId="${list.id }">${apiConfig == null?'无':apiConfig.name}</ruiec:apiConfig>

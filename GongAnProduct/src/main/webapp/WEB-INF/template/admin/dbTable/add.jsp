...
<body class="bodyCss">
        ...
        <section>
            ...
            <div class="mainRight">
                <div class="pancl_pd">
                    <form  action="/admin/dbTable/save.shtml" method="post" id="form1">
                                ...
                                <dd>
                                    <div class="fl rule-single-select single-select">
                                        ...
                                        <c:forEach var="dbShow" items="${dbShows }">
                                            <option value="${dbShow.id }">${dbShow.name }</option>
                                        </c:forEach>
                                        </select>
                                    </div>
                                </dd>
                            ...
                            <dl class="new_peo_list">
                                ...
                                <dd>
                                     <div class="fl left_item">
                                       <input type="text" class="txt_in" name="tableName" maxlength="50"/>
                                    </div>
                                </dd>
                            </dl>
                            <dl class="new_peo_list">

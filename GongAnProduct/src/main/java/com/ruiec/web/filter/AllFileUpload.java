 ...
 * Date: 2015年12月22日
 */
public class AllFileUpload implements Filter {
...
//						String content = FileClient.backgroundFileUpload(uploadedFile, dirName, "http://115.29.106.174:8090"/*SettingUtils.get().getFileServerUrl()*/);
						String content = FileClient.backgroundFileUpload(uploadedFile, dirName, "http://192.168.10.131:8091"/*SettingUtils.get().getFileServerUrl()*/);
